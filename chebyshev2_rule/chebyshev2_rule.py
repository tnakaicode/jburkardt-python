...
#
  ...
  print ( '' )
  print ( 'chebyshev2_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test chebyshev2_rule().' )
...
def chebyshev2_rule ( order, a, b, filename ):
...
#
  ...
  print ( '' )
  print ( 'chebyshev2_rule():' )
  print ( '  Compute a Gauss-Chebyshev type 2 rule for approximating' )
