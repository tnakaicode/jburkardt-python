...
#
  ...
  print ( '' )
  print ( 'chebyshev1_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test chebyshev1_rule().' )
...
def chebyshev1_rule ( order, a, b, filename ):
...
#
  ...
  print ( '' )
  print ( 'chebyshev1_rule():' )
  print ( '  Compute a Gauss-Chebyshev type 1 rule for approximating' )
  print ( '    Integral ( A <= x <= B ) f(x) / sqrt ( ( x - A ) * ( B - x ) ) dx' )
