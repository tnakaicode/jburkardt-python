...
def newton_coef_1d(nd, xd, yd):
    ...
    #
    #    Input, real XD(ND), the X values at which data was taken.
    #
    #    Input, real YD(ND), the corresponding Y values.
    #
    #    Output, real CD(ND), the divided difference
...
def newton_interp_1d_test():
    ...
    print('  Test the NEWTON_INTERP_1D library.')
#
#  Utility functions.
#
    p00_data_test()
...
def newton_value_1d(nd, xd, cd, ni, xi):
    ...
    #
    #    Input, real CD(ND), the divided differences.
    #
    #    Input, integer NI, the number of interpolation points.
    #
    #    Input, real XI(NI), the interpolation points.
    #
    #    Output, real YI(NI), the interpolation values.
    #
    import numpy as np
