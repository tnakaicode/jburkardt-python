...
#
  ...
  print ( '' )
  print ( 'cube_arbq_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test cube_arbq_rule().' )
...
def cube_arbq_rule_test01 ( degree, n ):
...
#
  ...
  print ( '' )
  print ( 'cube_arbq_rule_test01():' )
  print ( '  Quadrature rule for the symmetric cube.' )
...
def cube_arbq_rule_test02 ( degree, n, header ):
...
#
  print ( '' )
  print ( 'cube_arbq_rule_test02():' )
  print ( '  Get a quadrature rule for the symmetric cube.' )
...
def cube_arbq_rule_test04 ( degree, n ):
...
#
  ...
  npols = int ( ( ( degree + 1 ) * ( degree + 2 ) * ( degree + 3 ) ) / 6 )

  rints = np.zeros ( npols )

  for i in range ( 0, n ):

    pols = lege3eva ( degree, x[i,:] )

    for j in range ( 0, npols ):
      rints[j] = rints[j] + w[i] * pols[j]

  volume = 8.0
  d = 0.0
  d = ( rints[0] - np.sqrt ( volume ) )**2
...
#
  ...
  if ( degree == 1 ):
    ...
    print ( '' )
    print ( 'cube_arbq(): Fatal error!' )
    print ( '  Illegal value of DEGREE.' )
    raise Exception ( 'cube_arbq(): Fatal error!' )
...
#
  ...
  if ( degree < 1 or 15 < degree ):
    print ( '' )
    print ( 'cube_arbq_size(): Fatal error!' )
    print ( '  Illegal value of DEGREE.' )
    raise Exception ( 'cube_arbq_size(): Fatal error!' )

  n = n_save [ degree - 1 ]

  return n

def lege3eva ( degree, z ):
