...
#  Input:
#
#    integer F( integer I ), the name of the function 
#    to be analyzed.
#
#    integer X0, the starting point.
#
#  Output:
#
#    integer LAM, the length of the cycle.
#
#    integer MU, the index in the sequence starting
...
#*****************************************************************************80
#
## cycle_floyd_test() tests cycle_floyd().
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#  Input:
#
#    integer I, the argument of the function.
#    0 <= I <= 9.
#
#  Output:
#
