...
#    ibm 360/370 series.  The seventh set tests the failure detection.  The
...
#    thirteenth set tests the failure detection.  The fourteenth set is a
...
#    comments in subroutine) may be used on most machines but provide a
#    severe test of robustness only on the ibm 360/370 series.  The
#    tenth set tests the failure detection.  The eleventh set is a check
...
#    series.  The twenty-first set tests the failure detection.  The twenty-
...
#
  ...
  print ( '  toms577() evaluates the Carlson elliptic functions.' )
