...
def cyclic8_f(m, n, x):
    ...
    value = (
        ...
        x[3, 0:n] * x[4, 0:n] * x[5, 0:n] * x[6, 0:n]
        + x[0, 0:n] * x[1, 0:n] * x[2, 0:n] *
        x[3, 0:n] * x[4, 0:n] * x[5, 0:n] * x[7, 0:n]
        + x[0, 0:n] * x[1, 0:n] * x[2, 0:n] *
        x[3, 0:n] * x[4, 0:n] * x[6, 0:n] * x[7, 0:n]
        + x[0, 0:n] * x[1, 0:n] * x[2, 0:n] *
        x[3, 0:n] * x[5, 0:n] * x[6, 0:n] * x[7, 0:n]
        + x[0, 0:n] * x[1, 0:n] * x[2, 0:n] *
        x[4, 0:n] * x[5, 0:n] * x[6, 0:n] * x[7, 0:n]
        + x[0, 0:n] * x[1, 0:n] * x[3, 0:n] *
        x[4, 0:n] * x[5, 0:n] * x[6, 0:n] * x[7, 0:n]
        + x[0, 0:n] * x[2, 0:n] * x[3, 0:n] *
        x[4, 0:n] * x[5, 0:n] * x[6, 0:n] * x[7, 0:n]
