...
#*****************************************************************************80
#
## chebyshev1_exactness_test() tests chebyshev1_exactness().
#
#  Licensing:
#
...
#
  ...
  print ( '  Test chebyshev1_exactness().' )

  quad_filename = 'cheby1_o4'
  degree_max = 10
  
  chebyshev1_exactness ( quad_filename, degree_max )
#
#  Terminate.
#
  print ( '' )
...
def chebyshev1_exactness ( quad_filename, degree_max ):

#*****************************************************************************80
#
## chebyshev1_exactness() tests a Chebyshev quadrature rule for exactness.
#
#  Discussion:
#
...
#
  ...
  print ( '  type 1 quadrature rule by integrating all monomials up to a given' )
...
#
  print ( '' )
  print ( 'chebyshev1_exactness: User input:' )
...
#
  ...
  print ( '  a Gauss-Chebyshev type 1 rule' )
  print ( '  ORDER = ', order )
  print ( '' )
  print ( '  Standard rule:' )
...
#
  print ( '' )
  print ( '  A Gauss-Chebyshev type 1 rule would be able to exactly' )
...
def monomial_quadrature_chebyshev1 ( expon, order, w, x ):
