...
def sphere01_monomial_integral_test ( rng ):
...
#
  ...
  print ( '' )
  print ( 'sphere_integrals_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test sphere_integrals().' )

  rng = default_rng ( )

  sphere01_area_test ( )
  sphere01_monomial_integral_test ( rng )
  sphere01_sample_test ( rng )
#
#  Terminate.
#
  print ( '' )
