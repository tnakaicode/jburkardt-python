...
#*****************************************************************************80
#
## cg_squared_test() tests cg_squared().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'cg_squared_test' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test cg_squared().' )

  n = 10
  cg_squared_helmert ( n )

  n = 100
  cg_squared_lesp ( n )

  n = 20
  cg_squared_involutory ( n )
#
#  Terminate.
#
  print ( '' )
...
def cg_squared_helmert ( n ):

#*****************************************************************************80
#
## cg_squared_helmert() tests cg_squared() for the Helmert matrix.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'cg_squared_helmert():' )
  print ( '  Test cg_squared() on the Helmert matrix.' )
...
def cg_squared_involutory ( n ):

#*****************************************************************************80
#
## cg_squared_involutory() tests cg_squared() for the involutory matrix.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'cg_squared_involutory():' )
  print ( '  Test cg_squared() on the involutory matrix.' )
  print ( '  Number of variables N = ', n )
#
#  Get the matrix.
#
...
def cg_squared_lesp ( n ):

#*****************************************************************************80
#
## cg_squared_lesp() tests cg_squared() for the Lesp matrix.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'cg_squared_lesp():' )
  print ( '  Test cg_squared() on the Lesp matrix.' )
  print ( '  Number of variables N =', n )
#
#  Get the matrix.
#
...
def cg_squared ( A, b, x ):

#*****************************************************************************80
#
## cg_squared() applies the CG squared algorithm.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
#    real x(n): an initial solution estimate.
#
#  Output:
#
#    real x(n): the solution estimate after CG squared was applied.
#
  import numpy as np
  ...
  for it in range ( 1, max_iter + 1 ):
    ...
    phat = p.copy ( )
    vhat = np.matmul ( A, phat )
    alpha = rho / np.dot ( rtilde, vhat )
    q = u - alpha * vhat
    uhat = u + q
    x = x + alpha * uhat
    qhat = np.matmul ( A, uhat )
