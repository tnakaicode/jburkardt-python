...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  Test the SQUARE_INTEGRALS library.' )
#
#  Utility functions.
#
  i4vec_print_test ( )
...
#*****************************************************************************80
#
## SQUARESYM_AREA tests SQUARESYM_AREA.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  if ( e[0] < 0 or e[1] < 0 ):
    ...
    print ( '  All exponents must be nonnegative.' )
    exit ( 'SQUARESYM_MONOMIAL_INTEGRAL - Fatal error!' )
...
def squaresym_monomial_integral_test ( ):
...
#
  seed = 123456789
  x, seed = squaresym_sample ( n, seed )
...
#
  ...
  x, seed = r8mat_uniform_ab ( m, n, -1.0, +1.0, seed )

  return x, seed

def squaresym_sample_test ( ):
