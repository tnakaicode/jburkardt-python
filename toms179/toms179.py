...
#  Output:
#
#    real VALUE, the logarithm of the Gamma
#    function of X.
#
  import numpy as np
  ...
  if ( x <= 0.0 ):
    ...
    print ( '  X <= 0.0' )
    raise Exception ( 'alogam - Fatal error!' )
...
#
  ...
  while ( True ):
    ...
    print ( '  %8.4f  %24.16g  %24.16g  %10.2g' % ( x, fx, fx2, abs ( fx - fx2 ) ) )
...
#  Input:
#
#    real X, the value to which function is to be
#    integrated.  X must be in the range [0,1] inclusive.
#
#    real P, the first parameter.  P must be greater
#    than 0.0.
#
#    real Q, the second parameter.  Q must be greater
#    than 0.0.
#
#  Output:
#
#    real PROB.  The probability that a random variable
#    from a Beta distribution having arguments P and Q will be less than
#    or equal to X.
#
#  Local:
#
#    real ALEPS, the logarithm of EPS1.
#
#    real EPS, the machine precision.
#
#    real EPS1, the smallest representable number.
#
  import numpy as np
...
#
  ...
  if ( x < 0.0 ):
    ...
    print ( '  X < 0.0' )
    raise Exception ( 'mdbeta - Fatal error!' )
