...
#
  ...
  from r8_chop                     import r8_chop_test
  ...
  from r8_degrees                  import r8_degrees_test
  from r8_diff                     import r8_diff_test
  from r8_digit                    import r8_digit_test
  from r8_divide_i4                import r8_divide_i4_test
  ...
  from r8_factorial_stirling       import r8_factorial_stirling_test
  ...
  from r8_floor                    import r8_floor_test
  from r8_fraction                 import r8_fraction_test
  ...
  from r8_heaviside                import r8_heaviside_test
  from r8_huge                     import r8_huge_test
  from r8_hypot                    import r8_hypot_test
  from r8_is_in_01                 import r8_is_in_01_test
  from r8_is_inf                   import r8_is_inf_test
  from r8_is_insignificant         import r8_is_insignificant_test
  from r8_is_integer               import r8_is_integer_test
  from r8_is_nan                   import r8_is_nan_test
  from r8_log_10                   import r8_log_10_test
  ...
  from r8_nth_root                 import r8_nth_root_test
  from r8_pi                       import r8_pi_test
  from r8_pi_sqrt                  import r8_pi_sqrt_test
  from r8_power                    import r8_power_test
  from r8_power_fast               import r8_power_fast_test
  from r8_print                    import r8_print_test
  from r8_radians                  import r8_radians_test
  from r8_relu                     import r8_relu_test
  from r8_rise                     import r8_rise_test
  from r8_rise_values              import r8_rise_values_test
  from r8_round                    import r8_round_test
  ...
  from r8_sech                     import r8_sech_test
  from r8_sigmoid                  import r8_sigmoid_test
  from r8_sign                     import r8_sign_test
  from r8_sign_char                import r8_sign_char_test
  from r8_sign_match               import r8_sign_match_test
  from r8_sign_match_strict        import r8_sign_match_strict_test
  from r8_sign_opposite            import r8_sign_opposite_test
  from r8_sign_opposite_strict     import r8_sign_opposite_strict_test
  from r8_sign3                    import r8_sign3_test
  from r8_sincos_sum               import r8_sincos_sum_test
  from r8_sind                     import r8_sind_test
  from r8_softplus                 import r8_softplus_test
  from r8_sqrt_i4                  import r8_sqrt_i4_test
  from r8_swap                     import r8_swap_test
  from r8_swap3                    import r8_swap3_test
  from r8_tand                     import r8_tand_test
  from r8_tiny                     import r8_tiny_test
  from r8_to_dhms                  import r8_to_dhms_test
  ...
  from r8_unswap3                  import r8_unswap3_test
  ...
  from r8block_print               import r8block_print_test

  from r8mat_add                   import r8mat_add_test
  from r8mat_cholesky_factor       import r8mat_cholesky_factor_test
  from r8mat_cholesky_factor_upper import r8mat_cholesky_factor_upper_test
  from r8mat_cholesky_solve        import r8mat_cholesky_solve_test
  from r8mat_det_2d                import r8mat_det_2d_test
  from r8mat_det_3d                import r8mat_det_3d_test
  from r8mat_det_4d                import r8mat_det_4d_test
  from r8mat_diag_get_vector       import r8mat_diag_get_vector_test
  from r8mat_house_axh             import r8mat_house_axh_test
  from r8mat_house_form            import r8mat_house_form_test
  from r8mat_identity              import r8mat_identity_test
  from r8mat_indicator             import r8mat_indicator_test
  from r8mat_inverse_3d            import r8mat_inverse_3d_test
  from r8mat_is_binary             import r8mat_is_binary_test
  from r8mat_l_solve               import r8mat_l_solve_test
  from r8mat_lt_solve              import r8mat_lt_solve_test
  ...
  from r8mat_product_elementwise   import r8mat_product_elementwise_test
  from r8mat_ref                   import r8mat_ref_test
  from r8mat_rref                  import r8mat_rref_test
  from r8mat_scale_01              import r8mat_scale_01_test
  from r8mat_scale_ab              import r8mat_scale_ab_test
  from r8mat_solve                 import r8mat_solve_test
  from r8mat_standardize           import r8mat_standardize_test
  ...
  from r8mat_u_inverse             import r8mat_u_inverse_test
  from r8mat_u_solve               import r8mat_u_solve_test
  from r8mat_uniform_01            import r8mat_uniform_01_test
  from r8mat_uniform_ab            import r8mat_uniform_ab_test
  from r8mat_uniform_abvec         import r8mat_uniform_abvec_test
  from r8mat_ut_solve              import r8mat_ut_solve_test
  from r8mat_vand2                 import r8mat_vand2_test

  from r8rows_to_r8mat             import r8rows_to_r8mat_test

  from r8vec_amax                  import r8vec_amax_test
  from r8vec_amax_index            import r8vec_amax_index_test
  from r8vec_amin                  import r8vec_amin_test
  from r8vec_amin_index            import r8vec_amin_index_test
  from r8vec_asum                  import r8vec_asum_test
  from r8vec_binary_next           import r8vec_binary_next_test
  from r8vec_bracket               import r8vec_bracket_test
  from r8vec_bracket5              import r8vec_bracket5_test
  from r8vec_cheby_extreme         import r8vec_cheby_extreme_test
  from r8vec_cheby_zero            import r8vec_cheby_zero_test
  from r8vec_cheby1space           import r8vec_cheby1space_test
  from r8vec_concatenate           import r8vec_concatenate_test
  from r8vec_copy                  import r8vec_copy_test
  from r8vec_correlation           import r8vec_correlation_test
  from r8vec_covariance            import r8vec_covariance_test
  from r8vec_diff_norm             import r8vec_diff_norm_test
  ...
  from r8vec_eq                    import r8vec_eq_test
  from r8vec_even                  import r8vec_even_test
  from r8vec_even_select           import r8vec_even_select_test
  from r8vec_fill                  import r8vec_fill_test
  from r8vec_frac                  import r8vec_frac_test
  from r8vec_house_column          import r8vec_house_column_test
  from r8vec_identity_row          import r8vec_identity_row_test
  from r8vec_indicator0            import r8vec_indicator0_test
  from r8vec_indicator1            import r8vec_indicator1_test
  from r8vec_is_ascending          import r8vec_is_ascending_test
  from r8vec_is_ascending_strictly import r8vec_is_ascending_strictly_test
  from r8vec_is_binary             import r8vec_is_binary_test
  from r8vec_is_distinct           import r8vec_is_distinct_test
  from r8vec_is_in_01              import r8vec_is_in_01_test
  from r8vec_is_in_ab              import r8vec_is_in_ab_test
  from r8vec_is_insignificant      import r8vec_is_insignificant_test
  from r8vec_is_integer            import r8vec_is_integer_test
  from r8vec_is_negative           import r8vec_is_negative_test
  from r8vec_is_negative_any       import r8vec_is_negative_any_test
  from r8vec_is_nonnegative        import r8vec_is_nonnegative_test
  from r8vec_is_nonpositive        import r8vec_is_nonpositive_test
  from r8vec_is_nonzero_any        import r8vec_is_nonzero_any_test
  from r8vec_is_one                import r8vec_is_one_test
  from r8vec_is_positive           import r8vec_is_positive_test
  from r8vec_is_zero               import r8vec_is_zero_test
  from r8vec_linspace              import r8vec_linspace_test
  from r8vec_linspace2             import r8vec_linspace2_test
  from r8vec_max                   import r8vec_max_test
  from r8vec_max_abs_index         import r8vec_max_abs_index_test
  from r8vec_max_index             import r8vec_max_index_test
  from r8vec_mean                  import r8vec_mean_test
  from r8vec_mean_geometric        import r8vec_mean_geometric_test
  from r8vec_mean_running          import r8vec_mean_running_test
  from r8vec_mean_update           import r8vec_mean_update_test
  from r8vec_midspace              import r8vec_midspace_test
  from r8vec_min                   import r8vec_min_test
  from r8vec_mirror_next           import r8vec_mirror_next_test
  from r8vec_mirror_ab_next        import r8vec_mirror_ab_next_test
  ...
  from r8vec_print_some            import r8vec_print_some_test
  from r8vec_product               import r8vec_product_test
  from r8vec_reverse               import r8vec_reverse_test
  from r8vec_rotate                import r8vec_rotate_test
  from r8vec_rsquared              import r8vec_rsquared_test
  from r8vec_scale_01              import r8vec_scale_01_test
  from r8vec_scale_ab              import r8vec_scale_ab_test
  from r8vec_sign3_running         import r8vec_sign3_running_test
  from r8vec_smooth                import r8vec_smooth_test
  from r8vec_softmax               import r8vec_softmax_test
  from r8vec_sorted_nearest        import r8vec_sorted_nearest_test
  from r8vec_standardize           import r8vec_standardize_test
  from r8vec_std                   import r8vec_std_test
  from r8vec_std_sample            import r8vec_std_sample_test
  from r8vec_std_update            import r8vec_std_update_test
  from r8vec_step                  import r8vec_step_test
  from r8vec_sum                   import r8vec_sum_test
  from r8vec_sum_running           import r8vec_sum_running_test
  ...
  from r8vec_uniform_unit          import r8vec_uniform_unit_test
  from r8vec_variance              import r8vec_variance_test
  from r8vec_variance_circular     import r8vec_variance_circular_test
  from r8vec_variance_sample       import r8vec_variance_sample_test
  from r8vec_variance_update       import r8vec_variance_update_test

  from r8vec2_print                import r8vec2_print_test
  from r8vec2_print_some           import r8vec2_print_some_test
