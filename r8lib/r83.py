...
#
  ...
  print ( '  R83_CR_SL solves a factored system' )
  print ( '  after R83_CR_FA has factored it..' )
  print ( '' )
  print ( '  Matrix order N = %d' % ( n ) )
  print ( '  Demonstrate multiple system solution method.' )
  print ( '' )
...
#*****************************************************************************80
#
## R83_GS_SL_TEST tests R83_GS_SL for an R83 matrix.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## R83_JAC_SL_TEST tests R83_JAC_SL for an R83 matrix.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#    Input, integer M, N, the order of the matrix.
#
#    Input, real A_83(3,N), the R83 matrix.
#
#    Output, real A_GE(M,N), the R8GE matrix.
#
  import numpy as np
...
#
  ...
  print ( '  R83_TO_R8GE converse an R83 matrix to R8GE format.' )
  print ( '  We check three cases, M<N, M=N, M>N.' )
