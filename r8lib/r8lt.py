...
#
#    Output, real B(M,N), the copied matrix.
#
  import numpy as np
...
#    Input, integer M, N, the order of the matrix.
#
#    Input, real A_LT(M,N), the R8LT matrix.
#
