...
#
  ...
  print ( '' )
  print ( 'laguerre_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test laguerre_rule().' )
...
def laguerre_rule ( order, a, b, filename ):
...
#
  ...
  print ( '' )
  print ( 'laguerre_rule():' )
  print ( '  Compute a Gauss-Laguerre rule for approximating' )
  print ( '    Integral ( a <= x < +oo ) exp(-b*(x-a)) f(x) dx' )
  print ( '  of order ORDER.' )
  print ( '' )
  print ( '  The user specifies ORDER, A, B, and FILENAME.' )
  print ( '' )
  print ( '  ORDER is the number of points.' )
  print ( '  A is the left endpoint (typically 0).' )
