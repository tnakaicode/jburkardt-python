...
#
  ...
  for k in range ( kl, ku + 1 ):
    ...
    rldi = 1.0 / rld
    f[j-1,k-1,0] = ( f[j-1,k-1,0] - rld1 * f[j-2,k-1,0] ) * rldi
    f[j-1,k-1,1] = ( f[j-1,k-1,1] - rld1 * f[j-2,k-1,1] ) * rldi
    f[j-1,k-1,2] = ( f[j-1,k-1,2] - rld1 * f[j-2,k-1,2] ) * rldi
  ...
  for j in range ( jl + 2, ju - 1 ):
    for k in range ( kl, ku + 1 ):
      ...
      rld = c[j-1,k-1] - ( rld2 * y[j-3,k-1] + rld1 * x[j-2,k-1] )
      rldi = 1.0 / rld
      f[j-1,k-1,0] = ( f[j-1,k-1,0] - rld2 * f[j-3,k-1,0] - rld1 * f[j-2,k-1,0] ) * rldi
      f[j-1,k-1,1] = ( f[j-1,k-1,1] - rld2 * f[j-3,k-1,1] - rld1 * f[j-2,k-1,1] ) * rldi
      f[j-1,k-1,2] = ( f[j-1,k-1,2] - rld2 * f[j-3,k-1,2] - rld1 * f[j-2,k-1,2] ) * rldi
      x[j-1,k-1] = ( d[j-1,k-1] - rld1 * y[j-2,k-1] ) * rldi
      y[j-1,k-1] = e[j-1,k-1] * rldi
...
#
  for k in range ( kl, ku + 1 ):
    ...
    f[ju-2,k-1,0] = f[ju-2,k-1,0] - x[ju-2,k-1] * f[ju-1,k-1,0]
    f[ju-2,k-1,1] = f[ju-2,k-1,1] - x[ju-2,k-1] * f[ju-1,k-1,1]
    f[ju-2,k-1,2] = f[ju-2,k-1,2] - x[ju-2,k-1] * f[ju-1,k-1,2]

  for j in range ( 2, ju - jl + 1 ):
    jx = ju - j
    for k in range ( kl, ku + 1 ):
      f[jx-1,k-1,0] = f[jx-1,k-1,0] - x[jx-1,k-1] * f[jx,k-1,0] - y[jx-1,k-1] * f[jx+1,k-1,0]
      f[jx-1,k-1,1] = f[jx-1,k-1,1] - x[jx-1,k-1] * f[jx,k-1,1] - y[jx-1,k-1] * f[jx+1,k-1,1]
      f[jx-1,k-1,2] = f[jx-1,k-1,2] - x[jx-1,k-1] * f[jx,k-1,2] - y[jx-1,k-1] * f[jx+1,k-1,2]
