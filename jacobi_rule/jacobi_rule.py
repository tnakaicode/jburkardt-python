...
#
  ...
  print ( '' )
  print ( 'jacobi_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test jacobi_rule().' )
...
def jacobi_rule ( order, alpha, beta, a, b, filename ):

#*****************************************************************************80
#
## jacobi_rule() generates a Gauss-Jacobi quadrature rule.
#
#  Discussion:
#
...
#
#    real BETA: the exponent of (1+x)
#
#    real A: the left endpoint
#
#    real B: the right endpoint
#
#    string FILENAME: the root name of the output files.
#
  import numpy as np

  print ( '' )
  print ( 'jacobi_rule():' )
  print ( '  Compute a Gauss-Jacobi rule for approximating' )
  print ( '    Integral ( A <= x <= B ) (B-x)^alpha (x-A)^beta f(x) dx' )
  print ( '  of order ORDER.' )
  print ( '' )
  print ( '  The user specifies ORDER, ALPHA, BETA and FILENAME.' )
  print ( '' )
  print ( '  ORDER is the number of points' )
  print ( '  ALPHA is the exponent of (B-x):' )
  print ( '  BETA is the exponent of (x-A)' )
