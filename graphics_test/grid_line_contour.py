#! /usr/bin/env python3
#
def grid_line_contour ( ):

#*****************************************************************************80
#
## grid_line_contour() draws a contour line plot from a table Z(X,Y).
#
#  Discussion:
#
...
#
  ...
  print ( '' )
  print ( 'grid_line_contour():' )
  print ( '  python version:     ' + platform.python_version ( ) )
  print ( '  numpy version:      ' + np.version.version )
  print ( '  matplotlib version: ' + matplotlib.__version__ )
  print ( '  Make a contour line plot Z(X,Y) for a 41x41 table.' )
#
...
#
  ...
  plt.title ( 'Contour line plot of 41x41 table Z(X,Y)', fontsize = 16 )
  plt.xlabel ( '<--- X --->', fontsize = 16 )
  plt.ylabel ( '<--- Y --->', fontsize = 16 )
  filename = 'grid_line_contour.png'
