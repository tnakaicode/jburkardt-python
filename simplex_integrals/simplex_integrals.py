...
def simplex01_monomial_integral_test ( rng ):
...
#
  ...
  print ( '  Test simplex_integrals().' )

  rng = default_rng ( )
#
#  Library functions.
#
  simplex01_monomial_integral_test ( rng )
  simplex01_sample_test ( rng )
