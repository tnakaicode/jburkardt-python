#! /usr/bin/env python3
#
#  I had to create U and X here, in order for them to be visible 
#  to the animation frame function.
#
import numpy as np
nx = 101
u = np.zeros ( nx )
...
def allen_cahn_movie ( xi = 0.015, nu = 1.0 ):

#*****************************************************************************80
#
## allen_cahn_movie() makes a movie of successive solutions of the Allen-Cahn equation.
#
#  Discussion:
#
#    This version of the equation has the form:
...
#
#  You need this "backend" to create movies.
#
  matplotlib.use ( 'Agg' )

  print ( '' )
  print ( 'allen_cahn_movie():' )
  print ( '  Use the Euler method to solve the' )
  print ( '  Allen-Cahn 1D reaction-diffusion equation.' )
  print ( '  Save the successive time solutions to a movie file.' )
...
#
#  I couldn't use the "old" value of u until I added this global statement.
#
    global u
