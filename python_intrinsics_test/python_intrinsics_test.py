...
#
  ...
  for test in range ( 0, 10 ):
    i4 = rng.integers ( low = -100000000, high = +100000000, endpoint = True )
    i4_absolute = abs ( i4 )
...
#
  ...
  print ( '' )
  print ( 'bin_test():' )
  print ( '  bin() returns a string that is the binary representation' )
  print ( '  of an integer.' )
  print ( '' )
  print ( '      i         bin(i)' )
  print ( '' )
...
#
  print ( '' )
  print ( 'complex_test():' )
  print ( '  complex(x,y) converts two real numbers into one complex value.' )
  print ( '' )
...
#
  ...
  for test in range ( 0, 10 ):
    a = rng.integers ( low = -1000, high = +1000, endpoint = True )
    b = rng.integers ( low = -100, high = +100, endpoint = True )
    if ( b != 0 ):
      q, r = divmod ( a, b )
  ...
  for test in range ( 0, 10 ):
    a = 100.0 * rng.standard_normal ( )
    b = 10.0 * rng.standard_normal ( )
    q, r = divmod ( a, b )
...
#
  ...
  print ( '' )
  print ( 'floor_test():' )
  print ( '  floor(x) returns the largest integer no bigger than x.' )
  print ( '' )

  x = 12.34
  floor_x = floor ( x )
  print ( '  x =', x, ', floor(x)=', floor_x )
...
#
  ...
  data = np.array ( [ -1, -2, -3, 0, 1, 2, 12345, 2019, -11, 691752902764109836 ] )
...
#
  ...
  for test in range ( 0, 10 ):
    i1 = rng.integers ( low = -1000, high = +1000, endpoint = True )
    i2 = rng.integers ( low = -1000, high = +1000, endpoint = True )
    i3 = max ( i1, i2 )
  ...
  for test in range ( 0, 10 ):
    a = rng.integers ( low = -1000, high = +1000, size = 3, \
      endpoint = True )
    a_max = max ( a )
...
#
  ...
  for test in range ( 0, 10 ):
    r1 = 100.0 * rng.standard_normal ( )
    r2 = 100.0 * rng.standard_normal ( )
    r3 = min ( r1, r2 )
  ...
  for test in range ( 0, 10 ):
    a = 100.0 * rng.standard_normal ( size = 3 )
    a_min = min ( a )
...
#
  ...
  print ( '' )
  print ( 'oct_test():' )
  print ( '  oct() returns a string that is the octal representation' )
  print ( '  of an integer.' )
  print ( '' )
  print ( '      i         oct(i)' )
  print ( '' )
...
#
  ...
  print ( '' )
  print ( 'slice_test():' )
  print ( '  slice() creates an object represented' )
