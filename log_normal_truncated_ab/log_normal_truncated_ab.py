...
#    0.0 < X.
#
#    real MU, SIGMA, the parameter values of the PDF.
#    0.0 < SIGMA.
#
#  Output:
#
...
#
  ...
  if ( not check ):
    ...
    print ( '  The parameter values are not legal.' )
    return
  ...
  for i in range ( 0, 10 ):
    ...
    x = log_normal_sample ( mu, sigma, rng )
...
#*****************************************************************************80
#
## log_normal_check() checks the parameter values of the Log Normal PDF.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#  Output:
#
#    bool CHECK, is true if the parameter values are legal.
#
  check = True
...
#
  ...
  for i in range ( 0, nsample ):
    x[i] = log_normal_sample ( mu, sigma, rng )
...
#    0.0 < X.
#
#    real MU, SIGMA, the parameter values of the log normal PDF.
#    0.0 < SIGMA.
#
...
#
  ...
  if ( not check ):
    ...
    print ( '  Parameter values are not legal.' )
...
def log_normal_truncated_ab_cdf_test ( rng ):
...
#
  ...
  for i in range ( 0, 10 ):
    ...
    x = log_normal_truncated_ab_sample ( mu, sigma, a, b, rng )
...
def log_normal_truncated_ab_sample ( mu, sigma, a, b, rng ):
...
#
  ...
  cdf = lncdf_a + ( lncdf_b - lncdf_a ) * rng.random ( )

  x = log_normal_cdf_inv ( cdf, mu, sigma )

  return x

def log_normal_truncated_ab_sample_test ( rng ):
...
#
  ...
  x = np.zeros ( nsample )
  for i in range ( 0, nsample ):
    x[i] = log_normal_truncated_ab_sample ( mu, sigma, a, b, rng )
...
#
  ...
  log_normal_truncated_ab_cdf_test ( rng )
  log_normal_truncated_ab_sample_test ( rng )
...
#    real X, the argument of the CDF.
#
#    real A, B, the parameter values of the PDF.
#    0.0 < B.
#
#  Output:
#
...
#*****************************************************************************80
#
## normal_check() checks the parameter values of the Normal PDF.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
