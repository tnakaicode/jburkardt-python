...
#
  ...
  print ( '' )
  print ( 'gl_fast_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test gl_fast_rule().' )
...
#
  if ( n < 1 ):
    ...
    raise Exception ( 'GLPAIR - Fatal error!' )
...
#
  ...
  if ( n < 1 ):
    ...
    print ( '  Illegal value of N.' )
    raise Exception ( 'GLPAIRS - Fatal error!' )
...
#
  ...
  if ( l < 1 or 100 < l ):
    ...
    raise Exception ( 'GLPAIRTABULATED - Fatal error!' )
...
#  Output:
#
#    real THETA, the theta coordinate of the point.
#
  import numpy as np
  ...
  if ( l < 1 or 100 < l ):
    ...
    raise Exception ( 'LEGENDRE_THETA - Fatal error!' )
...
#  Output:
#
#    real WEIGHT, the weight of the point.
#
  import numpy as np
  ...
  if ( l < 1 or 100 < l ):
    ...
    print ( '  1 <= L <= 100 is required.' )
    raise Exception ( 'LEGENDRE_WEIGHT - Fatal error!' )
