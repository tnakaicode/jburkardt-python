...
#
  ...
  print ( '' )
  print ( '  abs(a) =             (%+g)'    % ( abs ( a ) ) )
  print ( '  arccos(a) =          (%+g%+g)' % ( ( np.arccos ( a ) ).real, ( np.arccos ( a ) ).imag ) )
  print ( '  arccosh(a) =         (%+g%+g)' %  ( ( np.arccosh ( a ) ).real, ( np.arccosh ( a ) ).imag ) )
  print ( '  angle(a) =           %+g'     % np.angle ( a ) )
  print ( '  arcsin(a) =          (%+g%+g)' % ( ( np.arcsin ( a ) ).real, ( np.arcsin ( a ) ).imag ) )
  print ( '  arcsinh(a) =         (%+g%+g)' %  ( ( np.arcsinh ( a ) ).real, ( np.arcsinh ( a ) ).imag ) )
  print ( '  arctan(a) =          (%+g%+g)' % ( ( np.arctan ( a ) ).real, ( np.arctan ( a ) ).imag ) )
  print ( '  arctanh(a) =         (%+g%+g)' %  ( ( np.arctanh ( a ) ).real, ( np.arctanh ( a ) ).imag ) )
  print ( '  complex(1) =         (%+g%+g)' % ( ( complex ( 1 ) ).real, ( complex ( 1 ) ).imag ) )
  print ( '  conjugate(a) =       (%+g%+g)' % ( np.conjugate ( a ).real, np.conjugate ( a ).imag ) )
  print ( '  cos(a) =             (%+g%+g)' %  ( ( np.cos ( a ) ).real, ( np.cos ( a ) ).imag ) )
  print ( '  cosh(a) =            (%+g%+g)' %  ( ( np.cosh ( a ) ).real, ( np.cosh ( a ) ).imag ) )
  print ( '  exp(a) =             (%+g%+g)' % ( ( np.exp ( a ) ).real, ( np.exp ( a ) ).imag ) )
  print ( '  a.imag =              %+g'     %  ( a.imag ) )
  print ( '  isinf(a) =            %+s'     % ( np.isinf(a) ) )
  print ( '  isnan(a) =            %+s'     % ( np.isnan(a) ) )
  print ( '  log(a) =             (%+g%+g)' % ( ( np.log ( a ) ).real, ( np.log ( a ) ).imag ) )
  print ( '  log10(a) =           (%+g%+g)' % ( ( np.log10 ( a ) ).real, ( np.log10 ( a ) ).imag ) )
  print ( '  a.real =              %+g'     %  ( a.real ) )
  print ( '  sin(a) =             (%+g%+g)' %  ( ( np.sin ( a ) ).real, ( np.sin ( a ) ).imag ) )
  print ( '  sinh(a) =            (%+g%+g)' %  ( ( np.sinh ( a ) ).real, ( np.sinh ( a ) ).imag ) )
  print ( '  sqrt(a) =            (%+g%+g)' %  ( ( np.sqrt ( a ) ).real, ( np.sqrt ( a ) ).imag ) )
  print ( '  tan(a) =             (%+g%+g)' %  ( ( np.tan ( a ) ).real, ( np.tan ( a ) ).imag ) )
  print ( '  tanh(a) =            (%+24.16g%+24.16g)' %  ( ( np.tanh ( a ) ).real, ( np.tanh ( a ) ).imag ) )
...
#
  ...
  print ( '  sqrt(a) =            (%+g%+g)' %  ( ( np.sqrt ( a ) ).real, ( np.sqrt ( a ) ).imag ) )
  print ( '  tan(a) =             (%+g%+g)' %  ( ( np.tan ( a ) ).real, ( np.tan ( a ) ).imag ) )
  print ( '  tanh(a) =            (%+g%+g)' %  ( ( np.tanh ( a ) ).real, ( np.tanh ( a ) ).imag ) )
