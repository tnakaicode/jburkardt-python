...
def allen_cahn_animation ( xi = 0.015, nu = 1.0 ):

#*****************************************************************************80
#
## allen_cahn_animation() displays successive solutions of the Allen-Cahn equation.
#
#  Discussion:
#
#    This version of the equation has the form:
...
#
  ...
  print ( '' )
  print ( 'allen_cahn_animation():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Use the Euler method to solve the time-dependent' )
  print ( '  Allen-Cahn 1D reaction-diffusion equation.' )
  print ( '  Display the solution at each timestep.' )
  print ( '  Interface thickness xi = ', xi )
...
#
  ...
  def animation_init():
    ...
    return line,
#
#  MATPLOTLIB animation needs this hideous "global u" statement!
#  MATPLOTLIB does NOT need a "global x" statement.
#
  def animation_frame ( j ):
    ...
    return line, 
#
#  In the following call to FuncAnimation(), interval is the interval in
#  milliseconds between each frame.  A value of 200 is the default.
#
  animation = FuncAnimation ( fig, init_func = animation_init, \
    func = animation_frame, 
    frames = np.arange ( 0, nt ), interval = 400, repeat = False,
    save_count = 1501 )
#
#  Save the frames to an MP4 file.
#
  filename = 'allen_cahn_animation.mp4'
...
if ( __name__ == '__main__' ):
  timestamp ( )
  allen_cahn_animation ( 0.015, 1.0 )
  timestamp ( )
