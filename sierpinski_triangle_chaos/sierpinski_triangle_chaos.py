#! /usr/bin/env python3
#
def sierpinski_triangle_chaos_test ( ):

#*****************************************************************************80
#
## sierpinski_triangle_chaos_test() tests sierpinski_triangle_chaos().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'sierpinski_triangle_chaos_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  sierpinski_triangle_chaos() uses an iterated map to plot' )
  print ( '  the Sierpinski triangle.' )

  n = 10000
  print ( '  Apply the iteration map', n, 'times.' )
  sierpinski_triangle_chaos ( n )
#
#  Terminate.
#
  print ( '' )
...
def sierpinski_triangle_chaos ( n ):

#*****************************************************************************80
#
## sierpinski_triangle_chaos() draws the Sierpinski triangle using an iterated function system.
#
#  Licensing:
#
#    This code is distributed under the MIT license. 
...
#
  ...
  plt.axis ( 'equal' )
  filename = 'sierpinski_triangle_chaos.png'
