#! /usr/bin/env python3
#
def change_dynamic_test ( ):

#*****************************************************************************80
#
## change_dynamic_test() tests change_dynamic().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'change_dynamic_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  change_dynamic() considers change-making problems.' )

  problems_test ( )
  change_dynamic_test01 ( )
#
#  Terminate.
#
  print ( '' )
...
def change_dynamic ( coin_num, coin_value, target ):

#*****************************************************************************80
#
## change_dynamic() solves the change making problem by dynamic programming.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
def change_dynamic_test01 ( ):

#*****************************************************************************80
#
## change_dynamic_test01() tests change_dynamic().
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  print ( '' )
  print ( 'change_dynamic_test01():' )
  print ( '  change_dynamic() computes A[T], the smallest number ' )
  ...
  for test in range ( 0, test_num ):
    ...
    a = change_dynamic ( coin_num, coin_value, target )
