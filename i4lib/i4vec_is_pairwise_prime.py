#! /usr/bin/env python
#
def i4vec_is_pairwise_prime ( n, a ):

#*****************************************************************************80
#
## I4VEC_IS_PAIRWISE_PRIME checks whether a vector of integers is pairwise prime.
#
#  Discussion:
#
...
def i4vec_is_pairwise_prime_test ( ):
...
#
  ...
  print ( '' )
  print ( 'I4VEC_IS_PAIRWISE_PRIME_TEST' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  I4VEC_IS_PAIRWISE_PRIME determines if a vector of' )
  ...
  for test in range ( 0, test_num ):
    ...
    value = i4vec_is_pairwise_prime ( n, x )
