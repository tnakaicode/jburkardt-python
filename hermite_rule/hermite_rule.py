...
#
  ...
  print ( '' )
  print ( 'hermite_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test hermite_rule().' )
...
def hermite_rule ( n, a, b, scale, filename ):
...
#
  ...
  print ( '' )
  print ( 'hermite_rule():' )
  print ( '  Compute a Gauss-Hermite rule for approximating' )
  print ( '    integral ( -oo < x < +oo ) f(x) rho(x) dx' )
  print ( '  where the weight rho(x) is:' )
  print ( '    exp ( - b * ( x - a )^2 ) * sqrt ( b / pi ) dx' )
  print ( '  using N points.' )
  print ( '' )
  print ( '  The user specifies N, A, B, SCALE, FILENAME.' )
  print ( '' )
  print ( '  N is the number of points' )
  print ( '  A is the center point (typically 0).' )
  print ( '  B is the exponential scale factor (typically 1).' )
  print ( '  SCALE is 1 if the weights are to be normalized.')
