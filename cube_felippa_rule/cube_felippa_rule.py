...
#
  ...
  print ( '' )
  print ( 'cube_felippa_rule_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test cube_felippa_rule().' )
...
def cube_monomial_test ( degree_max ):
...
#
  ...
  print ( '' )
  print ( 'cube_monomial_test():' )
  print ( '  cube_monomial() returns the exact value of the' )
  print ( '  integral of X^ALPHA Y^BETA Z^GAMMA over a cube.' )
  print ( '' )
  print ( '  Volume = ', cube_volume ( a, b ) )
  print ( '' )
  ...
  for alpha in range ( 0, degree_max + 1 ):
    ...
    for beta in range ( 0, degree_max - alpha + 1 ):
      ...
      for gamma in range ( 0, degree_max - alpha - beta + 1 ):
        expon[2] = gamma
        value = cube_monomial_integral ( a, b, expon )
        print ( '  %8d  %8d  %8d  %14.6e' \
          % ( expon[0], expon[1], expon[2], value ) )

  return

def cube_quad_test ( degree_max ):
...
#
  ...
  print ( '' )
  print ( 'cube_quad_test():' )
  print ( '  For the unit hexahedron,' )
  print ( '  we approximate monomial integrals with' )
  print ( '  cube_rule(), which returns N1 by N2 by N3 point rules.' )
  ...
  while ( True ):
    ...
    expon, more, h, t, n2, more2 = \
      subcomp_next ( degree_max, 3, expon, more, h, t, n2, more2 )
    ...
    for k in range ( 1, 6 ):
      ...
      quad = cube_volume ( a, b ) * np.dot ( w, v )
      print ( '  %6d  %6d  %6d  %14f' \
...
#
    ...
    print ( '' )
    quad = cube_monomial_integral ( a, b, expon )
...
def cube_monomial_integral ( a, b, expon ):

#*****************************************************************************80
#
## cube_monomial_integral() integrates a monomial over a cube in 3D.
#
#  Discussion:
#
...
#
  for i in range ( 0, 3 ):
    ...
    if ( expon[i] == -1 ):
      print ( '' )
      print ( 'cube_monomial_integral(): Fatal error!' )
      print ( '  Exponent of -1 encountered.' )
      raise Exception ( 'cube_monomial_integral(): Fatal error!' )
...
#
#    real XYZ(ORDER_1D(1)*ORDER_1D(2)*ORDER_1D(3),3), the abscissas.
#
  import numpy as np
  ...
  for i in range ( 0, 3 ):
    ...
    if ( o == 1 ):
      ...
      print ( '' )
      print ( 'cube_rule(): Fatal error!' )
      print ( '  Illegal value of ORDER_1D(*).' )
      raise Exception ( 'cube_rule(): Fatal error!' )
#
#  Transform from [-1,+1] to [Ai,Bi]
#
    w_1d = w_1d * ( b[i] - a[i] ) / 2.0
    x_1d = ( ( 1.0 - x_1d ) * a[i]   \
           + ( 1.0 + x_1d ) * b[i] ) \
           /   2.0
#
...
#
    xyz, contig, rep, skip = \
      r8vec_direct_product ( i, o, x_1d, 3, order, xyz, contig, rep, skip )

    w, contig2, rep2, skip2 = \
      r8vec_direct_product2 ( i, o, w_1d, 3, order, w, contig2, rep2, skip2 )
