#! /usr/bin/env python3
#
def disk01_integrands_test ( ):

#*****************************************************************************80
#
## disk01_integrands_test() tests disk01_integrands().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'disk01_integrands_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test disk01_integrands().' )

  rng = default_rng ( )

  disk01_integrands_test00 ( rng )
  disk01_integrands_test01 ( rng )
  disk01_integrands_test02 ( rng )
  disk01_integrands_test03 ( rng )
#
#  Terminate.
#
  print ( '' )
...
def disk01_integrands_test00 ( rng ):

#*****************************************************************************80
#
## disk01_integrands_test00(): integral of X^0 in the unit disk.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'disk01_integrands_test00():' )
...
def disk01_integrands_test01 ( rng ):

#*****************************************************************************80
#
## disk01_integrands_test01(): integral of X^EX in the unit disk.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'disk01_integrands_test01():' )
  print ( '  Use a simple Monte Carlo approach to estimate the' )
  print ( '  integral of X^EX inside the disk of radius 1' )
  print ( '  centered at the origin.' )
  print ( '' )
...
def disk01_integrands_test02 ( rng ):

#*****************************************************************************80
#
## disk01_integrands_test02(): integral of R^EX in the unit disk.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'disk01_integrands_test02():' )
  print ( '  Use a simple Monte Carlo approach to estimate the' )
...
def disk01_integrands_test03 ( rng ):

#*****************************************************************************80
#
## disk01_integrands_test03(): integral of exp(x) in the unit disk.
#
#  Licensing:
#
#    This code is distributed under the MIT license.
...
#
  ...
  print ( '' )
  print ( 'disk01_integrands_test03():' )
  print ( '  Use a simple Monte Carlo approach to estimate the' )
