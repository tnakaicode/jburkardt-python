#! /usr/bin/env python3
#
def cosine_integral_test ( ):

#*****************************************************************************80
#
## cosine_integral_test() tests cosine_integral().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'cosine_integral_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test cosine_integral().' )
...
#
  ...
  if ( xabs == 0.0 ):
    ...
    xcs = np.cos ( xabs / 2.0 )
    xss = np.sin ( xabs / 2.0 )
    value = el + np.log ( xabs ) - xabs * xss * xg1 + 2.0 * xcs * xg2 - 2.0 * xcs * xcs
    ...
    for k in range ( 1, 9 ):
      ...
      xg = xg + xr
    value = xf * np.sin ( xabs ) / xabs - xg * np.cos ( xabs ) / xabs
...
#
  ...
  print ( '' )
  print ( 'ci_plot():' )
  print ( '  ci() evaluates the cosine integral function.' )
  ...
  plt.xlabel ( '<--- X --->' )
  plt.ylabel ( '<--- Ci(x) --->' )
  plt.title ( 'The cosine integral function' )
...
#
  print ( '' )
  print ( 'ci_test():' )
  print ( '  ci() evaluates the Cosine Integral function CI(X).' )
  print ( '' )
  print ( '          X           CI(X)' )
  print ( '' )
