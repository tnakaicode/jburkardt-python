#! /usr/bin/env python3
#
def jacobi_exactness_test ( ):

#*****************************************************************************80
#
## jacobi_exactness_test() tests jacobi_exactness().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'jacobi_exactness_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test jacobi_exactness().' )

  jacobi_exactness ( 'jac_o2_a0.5_b1.5', 5, 0.5, 1.5 )
#
#  Terminate.
#
  print ( '' )
...
def jacobi_exactness ( quad_filename, degree_max, alpha, beta ):

#*****************************************************************************80
#
## jacobi_exactness() checks a Jacobi quadrature rule for exactness.
#
#  Discussion:
#
...
#
#    real ALPHA, the exponent of the (1-X) factor
#
#    real BETA, the exponent of the (1+X) factor.
#
  import numpy as np

  print ( '' )
  print ( 'jacobi_exactness():' )
  print ( '  Investigate the polynomial exactness of a Gauss-Jacobi' )
...
#
  ...
  print ( '  Exponent of (1-x), ALPHA = ', alpha )
  print ( '  Exponent of (1+x), BETA  = ', beta )
#
#  Read the X file.
#
...
#
  ...
  print ( '  a Gauss-Jacobi rule' )
  print ( '  ORDER = ', order )
  print ( '  ALPHA = ', alpha )
  print ( '  BETA  = ', beta )
  print ( '' )
  print ( '  Standard rule:' )
  print ( '    Integral ( -1 <= x <= +1 ) (1-x)^alpha (1+x)^beta f(x) dx' )
...
#
  print ( '' )
  print ( '  A Gauss-Jacobi rule would be able to exactly' )
...
def jacobi_monomial_integral ( expon, alpha, beta ):

#*****************************************************************************80
#
## jacobi_monomial_integral() evaluates the integral of a monomial with Jacobi weight.
#
#  Discussion:
#
...
#
  ...
  value = gamma ( 1.0 + c ) * ( s * gamma ( 1.0 + beta  ) * value1 \
    / gamma ( 2.0 + beta  + c ) \
...
def monomial_quadrature_jacobi ( expon, alpha, beta, order, w, x ):
...
#
  exact = jacobi_monomial_integral ( expon, alpha, beta )
#
