#! /usr/bin/env python3
#
def levy_dragon_chaos_test ( ):

#*****************************************************************************80
#
## levy_dragon_chaos_test() tests levy_dragon_chaos().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'levy_dragon_chaos_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  levy_dragon_chaos() uses an iterated map to plot the Levy dragon.' )
...
def levy_dragon_chaos ( n ):

#*****************************************************************************80
#
## levy_dragon_chaos() draws a Levy dragon using an iterated function system.
#
#  Licensing:
#
#    This code is distributed under the MIT license. 
...
#
  b0 = np.array ( [  0.500, 0.500 ] )
  b1 = np.array ( [ -0.500, 0.500 ] )
#
...
#
  ...
  filename = 'levy_dragon_chaos.png'
