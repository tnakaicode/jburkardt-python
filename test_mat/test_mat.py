...
#
  ...
  from r8mat_is_adjacency          import r8mat_is_adjacency_test
  from r8mat_is_anticirculant      import r8mat_is_anticirculant_test
  from r8mat_is_antisymmetric      import r8mat_is_antisymmetric_test
  from r8mat_is_eigen_left         import r8mat_is_eigen_left_test
  from r8mat_is_eigen_right        import r8mat_is_eigen_right_test
  from r8mat_is_identity           import r8mat_is_identity_test
  from r8mat_is_integer            import r8mat_is_integer_test
  ...
  from r8mat_is_orthogonal         import r8mat_is_orthogonal_test
  from r8mat_is_orthogonal_column  import r8mat_is_orthogonal_column_test
  from r8mat_is_orthogonal_row     import r8mat_is_orthogonal_row_test
  from r8mat_is_permutation        import r8mat_is_permutation_test
  from r8mat_is_plu                import r8mat_is_plu_test
  from r8mat_is_solution           import r8mat_is_solution_test
  from r8mat_is_sparse             import r8mat_is_sparse_test
  from r8mat_is_square             import r8mat_is_square_test
  from r8mat_is_symmetric          import r8mat_is_symmetric_test
  from r8mat_is_zero_one           import r8mat_is_zero_one_test
