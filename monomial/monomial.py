...
#
  ...
  print ( '  mono_between_enum() enumerates the monomials' )
...
#
  ...
  print ( '  mono_between_next_grevlex() lists the monomials' )
...
def mono_between_next_grlex_test ( rng ):
...
#
  ...
  print ( '  mono_between_next_grle() lists the monomials' )
  print ( '  in M variables, of total degree N between N1 and N2,' )
...
def mono_between_random ( m, n1, n2, rng ):
...
def mono_between_random_test ( rng ):
...
#
  ...
  for test in range ( 0, test_num ):
    x, rank = mono_between_random ( m, n1, n2, rng )
    print ( '  %2d    ' % ( rank ), end = '' )
    for j in range ( 0, m ):
      print ( '%2d' % ( x[j] ), end = '' )
    print ( '' )
...
#
  ...
  mono_between_next_grlex_test ( rng )
  ...
  mono_between_random_test ( rng )
  mono_total_random_test ( rng )
...
#
  ...
  print ( '  mono_total_enum() enumerates the monomials' )
...
#
  ...
  print ( '  mono_total_next_grevlex() lists the monomials' )
  print ( '  in M variables, of total degree N,' )
  print ( '  in grevlex order, one at a time.' )
  print ( '' )
...
def mono_total_random_test ( rng ):
...
#
  ...
  for test in range ( 0, test_num ):
    x, rank = mono_total_random ( m, n, rng )
    print ( '  %2d    ' % ( rank ), end = '' )
    for j in range ( 0, m ):
      print ( '%2d' % ( x[j] ), end = '' )
    print ( '' )
...
#
  ...
  print ( '  mono_upto_enum() enumerates the monomials' )
...
#
  ...
  print ( '  mono_upto_next_grevlex() lists the monomials' )
