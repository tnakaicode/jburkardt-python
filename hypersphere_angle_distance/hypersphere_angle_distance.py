#! /usr/bin/env python3
#
def hypersphere_angle_distance_test ( ):

#*****************************************************************************80
#
## hypersphere_angle_distance_test() tests hypersphere_angle_distance().
#
#  Licensing:
#
...
#
  ...
  print ( '' )
  print ( 'hypersphere_angle_distance_test():' )
  print ( '  python version: ' + platform.python_version ( ) )
  print ( '  numpy version:  ' + np.version.version )
  print ( '  Test hypersphere_angle_distance().' )

  for m in [ 2, 3, 5, 10, 20, 40, 80, 160 ]:
    n = 10000
    cost_mu, cost_std, theta_mu, theta_std = hypersphere_angle_stats ( m, n )
    print ( '' )
    print ( '  Using M =', m, 'spatial dimension' )
    print ( '  Using N =', n, 'sample points,', n )
    ...
    print ( '    Estimated mean = ', theta_mu, ' (radians), or ', \
      theta_mu * 180.0 / np.pi, ' (degrees)' )
    print ( '    Estimated std  = ', theta_std, ' (radians), or ', \
      theta_std * 180.0 / np.pi, ' (degrees)' )
  ...
  plt.grid ( True )
  filename = 'hypersphere_angle_distance.png'
